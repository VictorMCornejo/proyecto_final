        ...
        <div className="main">
            ...
            <section className="nosotrosTestimonio">
                <div className="testimonioCol1">
                    ...
                    <h3>"Somos una empresa comprometida con el desarrollo"</h3>
                </div>
                ...
                <div className="testimonioCol2">
                    ...
                    <p>En nuestros empleados buscamos un alto nivel de compromiso que se traduzca en acciones, un trabajo constante y la búsqueda por la superación diaria.</p>
                </div>
            </section>
           ...
           <section className="fondo-blanco seccion1 row justify-content-center">
               <h2>POR QUE ELEGIRNOS?</h2>
               <div className="col-6"> 
                    <p>En nuestros clientes, grandes o pequeños, encontrará excelentes relatos y buenas experiencias con nuestra empresa.</p>
                    <p>Brindamos un correcto asesoramiento técnico-comercial con una escucha activa de las necesidades, devolviéndole las alternativas adecuadas.</p>   
                    <p>Para el desarrollo de nuestras tareas, utilizamos avanzados sistemas de gestión interna y de gestión de clientes, y así evaluamos nuestro desempeño.</p> 
               </div>
               <div className="col-4">
                   <img src="/images/satisfaccion.webp" alt="satisfaccion" className="img-thumbnail"/>
               </div>            
           </section>
           <Contactate/>
        </div>
